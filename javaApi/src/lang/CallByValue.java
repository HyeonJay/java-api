...
public class CallByValue {
	...
	// 문자열은 char* 형 이므로 Call By Address라고 한다.
	// - Call By Value 인 경우 값을 전달하면 값을 전승한 원본 변수는 변형이 안된다.
	// 단지, stack 간의 값이 복사된다.
	// -Call By Reference의 경우 참조값( Hash Code) 를 전달한 객체는
	//  자신의 참조 값이 전달 됨으로써 값의 변화가 발생할 수 있다.
